...
class PocPreviewTests(unittest.TestCase):
    ...
    def test_requirement_generate_is_preview_only(self):
        ...
        self.assertIn("Outer diameter (mm)", requirements_body)
        self.assertIn("Swaging (mm)", requirements_body)
        self.assertIn("Target Kx (N/mm)", requirements_body)
        self.assertIn("Target Ky (N/mm)", requirements_body)
        self.assertIn("Target Kz (N/mm)", requirements_body)
        self.assertIn("Decking (mm)", requirements_body)
        self.assertIn("Internal teeth", requirements_body)
